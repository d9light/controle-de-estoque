    ...
    <div class="sidebar">
        ...
        <div class="side-content">
            <div class="profile">
                ...
                <h4><span> <?php @session_start();
                            echo $_SESSION['nome']; ?></span></h4>

                <small><?php @session_start();
                            echo $_SESSION['cargo']; ?></small>
            </div>
...
<div class="card">
    <div class="card-head">
        ...
        <a href="precoIdeal.php"><span class="las la-shopping-cart"></span></a>
    </div>
    ...
    <thead>
        <tr>
            <th>ID</th>
            <th><span class="las la-sort"></span> Funcionário</th>
    ...
    <tbody>
        ...
        if (isset($listaFuncionarios) && !empty($listaFuncionarios)) {
            foreach ($listaFuncionarios as $funcionario) {
                echo '<tr>';
                    echo '<td>' . $funcionario['id'] . '</td>'; // Acessando diretamente o array
                    echo '<td>';
                        echo '<div class="client">';
                            echo '<div class="client-info">';
                                echo '<h4>' . $funcionario['nome'] . '</h4>'; // Acessando diretamente o array
                                echo '<small>' . $funcionario['email'] . '</small>'; // Acessando diretamente o array
                            echo '</div>';
                        echo '</div>';
                    echo '</td>';
                    echo '<td>';
                        echo '<div class="actions">';
                        echo '<a class="btn btn-success" href="src/controller/UsuarioController.php?id=' . htmlspecialchars($funcionario['id']) . '&cmd=edit">
                        <span class="la la-edit" title="Editar"></span>
                      </a> | ';
                echo '<a class="btn btn-danger" href="src/controller/UsuarioController.php?id=' . htmlspecialchars($funcionario['id']) . '&cmd=delete" class="btn btn-danger">
